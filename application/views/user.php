...
<head>
  ...
  <title>CulturePedia | <?php echo $_SESSION['username'];?></title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <header class="main-header" style="background-color: #212529;" >
    <a href="<?php echo base_url('/beranda');?>" class="logo" style="background-color: #212529;" >
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs" id="demo"><?php echo $_SESSION['username'];?></span>
            </a>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              ...
              <div class="box-body table-responsive no-padding" id="tbl"  style="overflow: auto; height: 520px; width: 900px;" >
                <?php if($record == NULL):?>
              <h2 style="margin-left: 30px;">Anda belum memposting apapun</h2>
               <div class="col-xs-2">
                  <div class="box-tools">
                      <div class="input-group input-group-sm" style="width: 250px;">
                        <a href="<?php echo base_url('/user/tambah_konten');?>">
                        <button class="btn btn-success" style="margin-left: 12px;" >Tambah Konten</button>
                        </a>
                      </div>
                    </div>
                </div>
